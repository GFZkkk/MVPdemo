...
/**
 * Created by gaofengze on 2019/a1/9
 */
public class MyGridLayoutManagerDividerItem extends RecyclerView.ItemDecoration {
    private int leftRight;
    private int topBottom;

    public MyGridLayoutManagerDividerItem(int leftRight, int topBottom) {
