package com.example.gaofengze.demo.diy.player;
        ...
        onAudioFocusChangeListener = focusChange -> {
            switch (focusChange) {
                case AudioManager.AUDIOFOCUS_GAIN:
                    DeBugUtil.error("AUDIOFOCUS_GAIN");
                    break;
                case AudioManager.AUDIOFOCUS_LOSS:
                    //todo 判断如果不是外界造成的就不处理
                    DeBugUtil.error("AUDIOFOCUS_LOSS");

                    break;
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                    //todo 判断如果不是外界造成的就不处理
                    DeBugUtil.error("AUDIOFOCUS_LOSS_TRANSIENT");

                    break;
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK:
                    DeBugUtil.error("AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK");
                    break;
            }
        };
    }
